...
import { DeleteAccount } from '@/app/[locale]/(user)/settings/(index)/components/delete-account';
import { ChangePassword } from '@/app/[locale]/(user)/settings/(index)/components/change-password';
import { ChangeUsername } from '@/app/[locale]/(user)/settings/(index)/components/change-username';
